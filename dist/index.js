...
***************************************************************************** */
  ...
  function (e, t, n) {
    ...
    function L(e) {
      return _(e) || j(e) || w(e) || (Q(e) && L(e.ofType));
    }
    function k(e) {
      return _(e) || N(e) || I(e) || S(e) || j(e) || (Q(e) && k(e.ofType));
    }
    function x(e) {
      return _(e) || j(e);
    }
  ...
  function (e, t, n) {
    ...
    var r,
      i = (r = n(116)) && r.__esModule ? r : { default: r };
    function o(e) {
      return (o =
        'function' == typeof Symbol && 'symbol' == typeof Symbol.iterator
          ? function (e) {
  ...
  function (e, t, n) {
    ...
    function f(e) {
      var t = c(e);
      if (!o.has(t)) {
        var n = Object(i.parse)(e, { experimentalFragmentVariables: s });
  ...
  function (e, t, n) {
    ...
    (0, o(n(195)).default)().forEach(function (e) {
      var t = r(e, 2),
        n = t[0],
        o = t[1];
  ...
  function (e, t, n) {
    ...
    (I['[object Arguments]'] =
      ...
      (e.exports = function e(t, n, S, j, w, D) {
        ...
        var Q = P ? void 0 : (x ? (k ? d : p) : k ? N : _)(t);
        return (
          i(Q || t, function (r, i) {
      ...
      for (var o = 0, a = n.selections; o < a.length; o++) {
        ...
        switch (u.kind) {
          ...
          case m.Kind.INLINE_FRAGMENT:
            if (!L(e, u) || !k(e, u, t)) continue;
            A(e, t, u.selectionSet, r, i);
            break;
          case m.Kind.FRAGMENT_SPREAD:
            var c = u.name.value;
            if (i[c] || !L(e, u)) continue;
            i[c] = !0;
            var l = e.fragments[c];
            if (!l || !k(e, l, t)) continue;
        ...
        ? (function (e, t, n, r, i, o) {
            ...
            if ((0, l.default)(s))
              return s.then(function (a) {
                return G(e, C(a, e, t, n, r, o), n, r, i, o);
              });
            return G(e, C(s, e, t, n, r, o), n, r, i, o);
          })(e, t, n, o, u, f)
        : (0, E.isObjectType)(t)
        ? G(e, t, n, o, u, f)
        : void (0, a.default)(
  ...
  function (e, t, n) {
    ...
    Object.defineProperty(t, '__esModule', { value: !0 }),
      (t.extendSchema = function (e, t, n) {
        ...
        for (
          var A = e.toConfig(),
            L = new b.ASTDefinitionBuilder(n, function (e) {
              var t = k[e];
              if (void 0 === t)
  ...
  function (e, t, n) {
    ...
    var B = (e) => (t, n, r, i) => {
      switch (n) {
        ...
        case 'UPDATE':
          return { _set: K(e)(t, n, r, i), where: { id: { _eq: r.id } } };
        case 'UPDATE_MANY':
          return { _set: K(e)(t, n, r, i), where: { id: { _in: r.ids } } };
      }
    };
    const Y = (e = {}) =>
    ...
    const oe = (e) => {
        ...
        return t
          ? {
              function_name: t.groups.function,
              resource_name: t.groups.resource,
            }
          : void 0;
      },
      ae = (e, t, n) => (r) => {
        const i = r.resources.map((e) => e.type.name),
          o = r.queries
            .filter((e) => oe(e.description))
            .map((e) => oe(e.description)),
          a = [...i, ...o.map((e) => e.function)];
        return (i, u, s) => {
          let c = r.resources.find((e) => e.type.name === u);
          if (!c) {
            const e = o.find((e) => e.function_name === u);
            e &&
              ((c = r.resources.find((t) => t.type.name === e.resource_name)),
              (c = ((e, t) =>
                (e = {
                  ...e,
                  GET_LIST: { ...e.GET_LIST, name: t },
          ...
          if (!c)
            throw a.length
              ? new Error(
                  `Unknown resource ${u}. Make sure it has been declared on your server side schema. Known resources are ${a.join(
                    ', '
                  )}`
                )
              : new Error(
                  `Unknown resource ${u}. No resources were found. Make sure it has been declared on your server side schema and check if your Authorization header is properly set up.`
                );
          const l = c[i];
          if (!l)
            throw new Error(
              `No query or mutation matching fetch type ${i} could be found for resource ${c.type.name}`
            );
          const f = e(r)(c, i, s, l);
          return {
            query: t(r)(c, i, l, f),
            variables: f,
            parseResponse: n(r)(i, c, l),
          };
        };
      };
    var ue = ae(B, (e) => ie(e, Z, ne, te, re), $);
    const se = {
        introspection: {
          operationNames: {
            GET_LIST: (e) => '' + e.name,
    ...
    t.default = (e, t = {}, n = B, r = $) => {
      ...
      return L(a()({}, se, { buildQuery: o }, e)).then(
        (e) => (t, n, r) => e(t, n, r)
      );
    };
  },
...
const _LIB$buildFields = LIB.buildFields,
  _LIB$buildMetaArgs = LIB.buildMetaArgs,
  _LIB$buildArgs = LIB.buildArgs,
  _LIB$buildApolloArgs = LIB.buildApolloArgs,
  _LIB$defaultBuildVariables = LIB.defaultBuildVariables,
  _LIB$defaultGetResponseParser = LIB.defaultGetResponseParser,
  _LIB$buildQuery = LIB.buildQuery,
  _LIB$buildGqlQuery = LIB.buildGqlQuery,
  _LIB$buildVariables = LIB.buildVariables;
export default LIB.default;
export {
  _LIB$buildFields as buildFields,
  _LIB$buildMetaArgs as buildMetaArgs,
  _LIB$buildArgs as buildArgs,
  _LIB$buildApolloArgs as buildApolloArgs,
  _LIB$defaultBuildVariables as defaultBuildVariables,
  _LIB$defaultGetResponseParser as defaultGetResponseParser,
  _LIB$buildQuery as buildQuery,
  _LIB$buildGqlQuery as buildGqlQuery,
  _LIB$buildVariables as buildVariables,
};
