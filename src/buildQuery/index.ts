...
export const buildQueryFactory: BuildQueryFactory =
  ...
  (introspectionResults) => {
    ...
    const functionResources = getKnownResourceFunctions(introspectionResults);
    const functionNames = functionResources.map((f) => f?.function_name);
